...
<div align="center" style="font-weight: 50px; margin: 20px">DANH SÁCH SINH VIÊN</div>
...
<div align="center">
  <form method="POST"  action="../register.php" style="margin: 10px"><input class="button" type="submit" name="" value="Thêm sinh viên"></form>
   ...
   <table align="center" width="100%" style="vertical-align: middle; border: 1px;border-color:white;  background: white;">
		<tbody>
			<tr style="height: 50px; text-align: center; vertical-align:middle; background:#0c4ca3; color: white;">
				<td ><b>STT</b></td>
        <td><b>Tên đăng nhập(email)</b></td>
         <td><b>Mật khẩu</b></td>
