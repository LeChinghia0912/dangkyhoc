...
<div>
<div align="center">
  <form method="POST"  action="../controller/add_monhoc.php" style="margin: 10px"><input style="background: green;"class="button" type="submit" name="" value="Thêm môn học"></form>
